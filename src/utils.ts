...
/* One level of flattening. Stands in for Array.prototype.flat(), which the es6
   target doesn't have. Generic so it keeps the element type: number[][] gives
   number[], and Point[][] gives Point[]. */
